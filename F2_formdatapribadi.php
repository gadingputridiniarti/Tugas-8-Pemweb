...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="F2_Prosesdatapribadi.php">
                    ...
                    <div class="form-group row">
                        <label for="notelp" class="col-sm-2 col-form-label">Nomor Telpon</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nobantuan" id="nobantuan" class="form-control" <?php echo ($error_nobantuan !="" ? "is-invalid" : ""); ?>" placeholder="Apabila menerima" value="<?php echo $nobantuan; ?>"> <span class="warning"><?php echo $error_nobantuan ?></span>
                        </div>
                    </div> <br>
